...
class JavaCCParser implements JavaCCParserConstants {
    ...
    try {
      ...
      case FOR:
        jj_consume_token(FOR);
                ...
                JStatement forinit = null;
                ArrayList<JStatement> forUpdate;
                JStatement forupdate = null;
                JExpression expression;
                JStatement statements = null;
        ...
        statements = statement();
         statement = new JForStatement(line, forInit, expression,
      ...
      case DO:
        ...
        jj_consume_token(SEMI);
          statement = new JDoWhileStatement(line, condition, body);
        break;
      case SWITCH:
        ...
        while (true) {
          ...
          blockGroupStatement = switchBlockStatementGroup();
              switchBlockStatementGroup.add(blockGroupStatement);
        }
        jj_consume_token(RCURLY);
          statement = new JSwitchStatement(line, parExpression,
      ...
      case BREAK:
        jj_consume_token(BREAK);
                  line = token.beginLine;
          statement = new JBreakStatement(line, name);
        jj_consume_token(SEMI);
        break;
      case CONTINUE:
        jj_consume_token(CONTINUE);
                    line = token.beginLine;
          statement = new JContinueStatement(line, name);
        jj_consume_token(SEMI);
        break;
      case SEMI:
        jj_consume_token(SEMI);
  ...
  final private JSwitchBlockStatement switchBlockStatementGroup() throws ParseException {
    int line = 0;
    ...
    try {
      ...
      block = blockStatement();
         blockStatement.add(block);
    } catch (ParseException e) {
        recoverFromError( new int[] {SEMI, EOF}, e);
    }
      {if (true) return new JSwitchBlockStatement(line, switchLabels, blockStatement);}
    throw new Error("Missing return statement in function");
  }
  ...
  final private JStatement defaultLabel() throws ParseException {
    JStatement statement = null;
    try {
      jj_consume_token(Default);
      jj_consume_token(COLON);
  ...
  final private ArrayList<JStatement> forInit(int line) throws ParseException {
    ...
    try {
      if (jj_2_10(2147483647)) {
        // [final] type variableDeclarators
                    type = type();
        varDecl = variableDeclarators(type);
             forInit.add(new JForInitDeclaration(line, varDecl));
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case FALSE:
        case NEW:
  ...
  final private ArrayList<JStatement> forUpdate() throws ParseException {
  ...
  final private JExpression conditionalExpression() throws ParseException {
    ...
    JExpression yesReturn = null;
    JExpression noReturn = null;
    try {
      ...
      case QUES:
        ...
        yesReturn = assignmentExpression();
        jj_consume_token(COLON);
        noReturn = conditionalExpression();
              lhs = new JConditionalExpression(line, lhs, yesReturn, noReturn);
        break;
      default:
        jj_la1[38] = jj_gen;
        ;
  ...
  final private boolean jj_3R_54() {
    if (jj_scan_token(QUES)) return true;
  ...
  final private boolean jj_3R_76() {
    if (jj_scan_token(NOT_ASSIGN)) return true;
  ...
  final private boolean jj_3R_62() {
    if (jj_scan_token(USHR_ASSIGN)) return true;
    if (jj_3R_46()) return true;
    return false;
  }
  ...
  final private boolean jj_3R_57() {
    if (jj_scan_token(MIN_ASSIGN)) return true;
    if (jj_3R_46()) return true;
    return false;
  }
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x200000,0x10000,0x5c00900,0x5c00100,0x5c00100,0x2000,0x45c40700,0x40040600,0x0,0x40600,0xba1cc600,0xba18c000,0x381c4600,0x38184000,0xba1cc600,0x38184000,0xba18c000,0x0,0x0,0x38184000,0x0,0x38184000,0x0,0x40600,0x0,0x0,0x38184000,0x0,0x38184000,0x0,0x38184000,0x40600,0x40600,0x0,0x0,0x40600,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x20000,0x20000,0x0,0x0,0x0,0x0,0x0,0x0,0x38184000,0x0,0x38184000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x38184000,0x40600,0x0,0x0,0x0,0x20104000,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x1040,0x1040,0x0,0x1040,0x64a7269,0x64a6229,0x64a1040,0x64a0000,0x64a727b,0x64a0000,0x64a6229,0x12,0x0,0x64a0000,0x0,0x64a0000,0x0,0x1040,0x0,0x40000,0x64a0000,0x0,0x64a0000,0x0,0x64a0000,0x1040,0x1040,0x0,0x0,0x1040,0x8040000,0x8040000,0x0,0x0,0x800000,0x0,0x0,0x0,0x100000,0x100000,0x1200000,0x1200000,0x80000000,0x80000000,0x4020000,0x4020000,0x70000000,0x70000000,0x64a0000,0x2000000,0x0,0x0,0x480000,0x480000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1040,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x80000000,0x8800000,0x80000000,0x88a00000,0x88a00000,0x80200000,0x80200000,0x88a00000,0x80200000,0x88a00000,0x0,0x10000000,0x80200000,0x10000000,0x80200000,0x10000000,0x80000000,0x10000000,0x0,0x80a00000,0x10000000,0x80a00000,0x10000000,0x80200000,0x0,0x0,0x2000000,0x2000000,0x80000000,0x16bf00,0x16bf00,0x40,0x80000,0x0,0x4,0x8,0x10,0x80,0x80,0x14000,0x14000,0x3,0x3,0x0,0x0,0x0,0x0,0x80200000,0x0,0x80200000,0x22000000,0x0,0x0,0x200000,0x22000000,0x200000,0x200000,0x20200000,0x200000,0x80200000,0x80000000,0x800000,0x200000,0x2000000,0x0,};
   }
   private static void jj_la1_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x8b8,0x8b8,0x8b8,0x8b8,0x8b8,0x8b8,0x8b8,0x0,0x0,0x8b8,0x0,0x8b8,0x0,0x0,0x0,0x0,0x8b8,0x0,0x8b8,0x0,0x8b8,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x8b8,0x0,0x8b8,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x8b8,0x0,0x0,0x0,0x0,0x8b8,};
   }
