...
public class Parser {
        ...
        if (see(LCURLY)) {
            ...
            if (!see(SEMI)) {
                if (seeBasicType() || seeReferenceType()) {
                    ...
                    forInit.add(new JVariableDeclaration(line, mods, decls));
                } else {
    ...
    private JExpression conditionalExpression() {
        ...
        while (more) {
            if (have(QUES)) {
                JExpression yesReturn = assignmentExpression();
                mustBe(COLON);
                JExpression noReturn = conditionalExpression();
                return new JConditionalExpression(line, lhs, yesReturn, noReturn);
            } else {
                more = false;
            }
        }
